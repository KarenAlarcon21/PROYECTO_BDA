...
<html>
    ...
    <body  class="box";">         
        <div>
            <div>                
                ...
                <div style="display: flex;">
                    ...
                    <img src="https://cdnwordpresstest-f0ekdgevcngegudb.z01.azurefd.net/es/wp-content/uploads/2023/10/Trasplante-de-Corazon-1.jpg" alt="Imagen_1" width="400" height="200">
                </div>
            </div><br>
            ...
            <div> 
                ...
                <div class="galeria-fotos">                    
                    <img src="https://img.freepik.com/vector-premium/buen-hospital-tendra-sistema-servicios-procedimiento-claro-estandares-salud-publica_1150-50288.jpg" alt="Imagen 2" width="400" height="200">
                    <img src="https://hospitecnia.com/sites/default/files/styles/node_teaser/public/2023-03/cabecera-unidad-quemados.jpg?itok=8iQ7zZCH" alt="Imagen 3" width="400" height="200">            
                </div>
            </div><br>
            <hr style="color: green;"><br>
            <div>
                ...
                <div style="display: flex;">
                    <p>En nuestra red hospitalaria, nos enorgullecemos de contar con un abanico completo de especialidades médicas. Nuestro compromiso es proporcionar atención integral y especializada a nuestros pacientes. Entre las especialidades médicas disponibles se incluyen muchas áreas de atención médica especializada. Estamos dedicados a brindar un cuidado médico de la más alta calidad en cada una de nuestras especialidades para garantizar el bienestar y la salud de nuestra comunidad.
                        <br>Entre las especialidades médicas disponibles se incluyen:<br>                      
                        <br>Medicina Interna
                        <br>Cardiología
                        <br>Pediatría
                        <br>Ginecología y Obstetricia
                        <br>Traumatología
                        <br>Oncología
                        <br>Neurología
                        <br>Endocrinología
        ...
        <div> 
            ...
            <div class="galeria-fotos">
                <img src="https://bogota.gov.co/sites/default/files/styles/1050px/public/field/image/Hospital%20Universitario%20Nacional%20de%20Colombia.jpg" alt="Imagen 1" width="400" height="200">
                <img src="https://www.hospitalsanpedro.org/wp-content/uploads/2023/06/1er_trasplante.jpg" alt="Imagen 3" width="400" height="200">            
            </div>
        </div><br>
